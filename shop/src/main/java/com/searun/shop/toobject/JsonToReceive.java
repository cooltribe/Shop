...
public class JsonToReceive {
	 ...
	 */
	public static  PdaResponse<ReceiverDto> parserLoginJson(String json)
			throws JSONException {
		PdaResponse<ReceiverDto> response = new PdaResponse<ReceiverDto>();
		try {
			Type type = new TypeToken<PdaResponse<ReceiverDto>>() {
			}.getType();
