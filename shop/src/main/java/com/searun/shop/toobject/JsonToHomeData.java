...
public class JsonToHomeData {
	 ...
	 */
	public static  PdaResponse<HomeDataDto> parserLoginJson(String json)
			throws JSONException {
		PdaResponse<HomeDataDto> response = new PdaResponse<HomeDataDto>();
		try {
			Type type = new TypeToken<PdaResponse<HomeDataDto>>() {
			}.getType();
